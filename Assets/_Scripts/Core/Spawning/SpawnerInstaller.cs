...
namespace MagmaHeart.Core.Spawning
{
    ...
    {
        public MagmaHeartSpawner Install(IEnumerable<GameObject> enemyPrefabs, Player player, GameObject projectilePrefab, AIContext aiContext, RoomGrid roomGrid, float minDistanceFromPlayer)
        {
            ...
            EnemySpawner enemySpawner = new EnemySpawner(spawnService, player, minDistanceFromPlayer, enemyPrefabs.ToList(), factory);
